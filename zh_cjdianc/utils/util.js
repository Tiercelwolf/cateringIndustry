...
function sortOut(property) {//排序，由小到大
  return function (a, b) {
...
function sortOutBIG(property) {//排序，由大到小
  return function (a, b) {
    var value1 = a[property];
    var value2 = b[property];
...
function arrayWeightRemoval(array1,array2){
...
// 将模块接口暴露出来，否则报错-eg: util.sortOut is not a function;
module.exports = { 
    ...
    ormatDate: ormatDate,
    sortOut: sortOut,
    sortOutBIG: sortOutBIG,
    arrayWeightRemoval: arrayWeightRemoval
};
