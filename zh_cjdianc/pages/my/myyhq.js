...
Page({
    ...
    qsy: function(t) {
      ...
      if (this.data.use_type === "undefined" || typeof (this.data.use_type) === "undefined" || this.data.use_type === "") {
        wx.redirectTo({
          url: '/zh_cjdianc/pages/seller/showGoods?hyid=' + id + "&coupon_full=" + full + "&yhqcoupon_reduce=" + reduce
        });
      } else {
        wx.redirectTo({
          url: '/zh_cjdianc/pages/takeout/takeoutform?hyid=' + id + "&coupon_full=" + full + "&yhqcoupon_reduce=" + reduce + "&orderType_index=" + this.data.orderType_index
        })
      }  
    },
        ...
        app.util.request({
           url: "entry/wxapp/MyCoupons",
            ...
            // url: 'http://192.168.10.4:7300/mock/5b782535bfe92705006efea3/wxapp/Mycoupons',
              //  url:'http://192.168.10.4:7300/mock/5bc5de72363a0e050d79bce0/example/Shoppreferences',
            ...
            success: function(t) {
                ...
                1 == t.data[n].type && a.push(t.data[n]);
              console.log("---yhq--a--a--a--优惠券---", a, "--yhq--e---e---e-红包---", e) 
                o.setData({
                    ptarr: a,
                    sjarr: e,
                  isloading: !1,
