...
Page({
    ...
    onLoad: function(t) {
        ...
        // app.util.request({
            ...
            wx.request({
              url: 'http://192.168.10.4:7300/mock/5b782535bfe92705006efea3/wxapp/Gethyqx', //显示“[]”无数据
            cachetime: "0",
            success: function(t) {
    ...
    formSubmit: function(a) {
        var o = this, i = a.detail.formId, n = this.data.userInfo.openid, t = this.data.userInfo.id, s = Number(this.data.zfmoney), e = this.data.month, l = this.data.lxr, d = this.data.tel;
        if (console.log(n, t, s, i, e, l, d), "yezf" == a.detail.value.radiogroup) {
            var r = Number(this.data.userInfo.wallet), u = s;
        ...
        console.log("支付方式", c), "" == i ? wx.showToast({
            ...
            success: function(t) {
                ...
                o.setData({
                    ...
                    title: "支付失败",
                    icon: "loading"
                })), "wxzf" == a.detail.value.radiogroup && (console.log("微信支付流程"), 0 == s ? (wx.showModal({
                    title: "提示",
