...
//--现：接口测试连接-----------------------------------------------------------------------------------
util.url = function (e, t) {
  console.log("yzh地址" + e + "tyzh::::::::" + t)
  // n是app实例
  // a = i t v from
  var yes = e.split("/")[2]
  // var id = e.split("/")[3]
  console.log("我要看yes" + yes)
  var n = getApp(), a = n.siteInfo.siteroot +
    "/" + yes +
    "?i=" + n.siteInfo.uniacid +
    "&s="+n.siteInfo.shopid +
    // "&id=" + id +
    "&t=" + n.siteInfo.multiid + "&v=" + n.siteInfo.version; 
    // + "&from=wxapp&";
  // e[0]是entry
  // if (e && ((e = e.split("/"))[0] && (a += "c=" + e[0] + "&"), e[1] && (a += "a=" + e[1] + "&"),
  //   e[2] && (a += "do=" + e[2] + "&")), t && "object" === (void 0 === t ? "undefined" : typeof(t))) for (var r in t) r && t.hasOwnProperty(params) && t[r] && (a += r + "=" + t[r] + "&");
  // console.log("yzh地址" + e + "tyzh::::::::" + t)
  return a;
},
//--现：接口测试连接-----------------------------------------------------------------------------------
...
util.request = function(a) {
    ...
    var n = wx.getStorageSync("users").sessionid, i = a.url;
    ...
    if(util.validatevar(a.data))
        a.data = util.removeinvalidattrs(a.data)
    ...
    wx.request((_defineProperty(e = {
        ...
        if (wx.hideNavigationBarLoading(), wx.hideLoading(), e.data.errno) {
            if ("41009" == e.data.errno) return wx.setStorageSync("users", ""), r.getUserInfo(), util.request(a);
...
util.navigateBack = function(t) {
    ...
    if (!e) return !0;
    if ("object" == (void 0 === e ? "undefined" : typeof(e)) && (t = e.redirect, n = e.type, 
    e = e.title), t) {
...
util.validatevar= function(param){
...
util.removeinvalidattrs = function(obj){
  if(typeof obj !== "object") return obj;
  var props = Object.getOwnPropertyNames(obj)
  for(let prop of props){
    if(!util.validatevar(obj[prop]))
      delete obj[prop]
  }
  return obj
}
